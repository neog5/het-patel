...
const About = () => {
  ...
  return (
    ...
    <motion.div
      id="about"
      className="px-64 py-20 xs:py-24 md:py-32 lg:py-36"
      initial={{ opacity: 0, y: 50 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.2, duration: 0.5 }}
      viewport={{ once: true }}
    >
      <h2 className="flex items-center text-3xl font-bold mb-10 w-full whitespace-nowrap after:content-[''] after:block after:h-[1px] after:bg-slate-700 after:w-full after:ml-5 after:relative after:top-[2px]">
      ...
      <main className="flex gap-16 items-center lg:items-start flex-col lg:flex-row">
        <div className="space-y-4 lg:w-3/5">
          <p>
            Hi, I’m {author.name}. I enjoy creating things that can make daily
            life easier and more enjoyable. My journey into programming began in
            high school when I started learning C++.
          </p>
          <p>
            Fast-forward to today, I’ve had the privilege of working in the
            industry for 2 years. With experience at companies like{" "}
            <Link
